...
export const areasOfLawContent = {
  'estate-and-probate-law': {
    ...
    breadcrumbHref: '/estate-and-probate-law',
    ...
    moreInfoHref: '/estate-and-probate-law/summary',
...
متوفی را مشخص می‌کند</p>
  ...
  'commercial-law': {
    ...
    moreInfoHref: '/commercial-law/summary',
  ...
  'criminal-law': {
    ...
    moreInfoHref: '/criminal-law/summary',
...
اگر به اطلاعات خاصی در زمینه حقوق کیفری ایران نیاز دارید، از دستیار هوش مصنوعی ما بپرسید.
  ...
  'employment-law': {
    ...
    moreInfoHref: '/employment-law/summary',
...
۴. آیین‌نامه‌ها و بخشنامه‌های وزارت کار<br>
 ...
 • مقررات مربوط به دورکاری و مشاغل خاص</p>`
  ...
  'family-law': {
    ...
    moreInfoHref: '/family-law/summary',
    introImage: '/assets/default-area-of-law.webp',
...
<li><p><strong>قوانین مربوط به حضانت و نفقه کودک</strong> حقوق والدین و مسئولیت‌های مالی را برای تأمین رفاه کودکان تعیین می‌کند، با نظارت سازمان‌های حمایتی مانند کمیته حمایت از کودکان.</p></li>
  ...
  'immigration-law': {
    ...
    breadcrumbHref: '/immigration-law',
    ...
    moreInfoHref: '/immigration-law/summary',
    introImage: '/assets/default-area-of-law.webp',
...
<li><p><strong>قانون تابعیت</strong> شرایط تابعیت ایرانی، از جمله الزامات اقامت، مهارت زبان و دانش شهروندی را تعیین می‌کند.</p></li>
  ...
  'litigation': {
    ...
    moreInfoHref: '/litigation/summary',
    introImage: '/assets/default-area-of-law.webp',
...
<li><p><strong>صلاحیت محلی دادگاه‌ها</strong> به دادگاه‌ها اجازه می‌دهد اختلافات بین شهروندان استان‌های مختلف را رسیدگی کنند و جایگزینی برای دادگاه‌های محلی فراهم می‌کند.</p></li>
  ...
  'personal-injury-law': {
    ...
    breadcrumbHref: '/personal-injury-law',
    ...
    moreInfoHref: '/personal-injury-law/summary',
    introImage: '/assets/default-area-of-law.webp',
...
<li><p><strong>مهلت قانونی طرح دعوا</strong> محدودیت‌های زمانی دقیقی برای طرح دعاوی جراحات شخصی تعیین می‌کند که معمولاً از یک تا شش سال بسته به استان و نوع ادعای آسیب متغیر است.</p></li>
  ...
  'property-law': {
    ...
    moreInfoHref: '/property-law/summary',
    introImage: '/assets/default-area-of-law.webp',
