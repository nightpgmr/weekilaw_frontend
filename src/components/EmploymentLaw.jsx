...
const EmploymentLaw = () => {
  ...
  const subCategories = [
    {
      title: 'اخراج نادرست و کار به‌طور آزاد',
      image: '/assets/employment-law/1.webp',
      description: 'آیا به طور ناگهانی از شغل خود اخراج شده‌اید؟ دستیار حقوقی ما توضیح می‌دهد که ادعاهای اخراج نادرست چیست، حقوق شما در اشتغال به‌طور آزاد چیست، استثنائات اشتغال به‌طور آزاد چگونه است و چطور می‌توانید شکایات خود را به کمیسیون فرصت‌های شغلی برابر (EEOC) ارسال کنید. در این مطلب با فعالیت‌های محافظت‌شده، استثنائات مربوط به سیاست‌های عمومی و زمانی که اخراج ممکن است قوانین ضد تبعیض فدرال یا ایالتی را نقض کند، آشنا شوید.'
    },
    {
      title: 'بررسی یا اعتراض به قرارداد کاری',
      image: '/assets/employment-law/2.webp',
      description: 'نگران شرایط قرارداد کاری خود هستید یا با نقض قرارداد مواجه شده‌اید؟ اطلاعات واضحی در مورد مفاد قرارداد، توافق‌نامه‌های تسویه حساب، بندهای عدم رقابت و گزینه‌های خود در مواقع بروز اختلافات در قرارداد کاری دریافت کنید. چه در حال بررسی پیشنهاد شغلی باشید و چه با تغییرات قرارداد روبه‌رو شوید، موقعیت قانونی خود را طبق قوانین قراردادهای ایالتی (یا ملی) درک کنید.'
    },
    {
      title: 'آزار، تبعیض و تلافی در محیط کار',
      image: '/assets/employment-law/3.webp',
      description: 'آیا در محیط کار خود با آزار، تبعیض یا تلافی مواجه شده‌اید؟ تکنولوژی هوش مصنوعی ما، حمایت‌های قانونی شما تحت قانون عنوان هفتم، قانون آمریکایی‌ها با معلولیت‌ها (ADA)، قانون تبعیض سنی در استخدام (ADEA) و سایر قوانین فدرال را توضیح می‌دهد. با ادعاهای محیط کار خصمانه، آزار جنسی از نوع "quid pro quo" و مراحل اقداماتی که می‌توانید انجام دهید، از جمله ثبت شکایات در کمیسیون فرصت‌های شغلی برابر (EEOC)، آشنا شوید.'
    },
    {
      title: 'مسائل مربوط به حقوق و ساعات کاری',
      image: '/assets/employment-law/4.webp',
      description: 'آیا به درستی پرداخت نمی‌شوید یا با حقوق معوقه مواجه هستید؟ "قانون‌کانکت" توضیح می‌دهد که شرایط قانون استانداردهای کار منصفانه (FLSA) چیست، حقوق مربوط به اضافه‌کاری، حقوق حداقل دستمزد و اقداماتی که باید در صورت خودداری کارفرمایان از پرداخت حقوق انجام دهید. اطلاعاتی در مورد طبقه‌بندی‌های معاف و غیرمعاف، الزامات استراحت و صرف غذا و همچنین نحوه ثبت شکایات حقوقی در وزارت کار دریافت کنید.'
    },
    {
      title: 'اخراج‌ها، کاهش نیرو و الزامات قانون WARN',
      image: '/assets/employment-law/5.webp',
      description: 'آیا با اخراج یا کاهش نیرو مواجه شده‌اید؟ دستیار هوش مصنوعی ما الزامات قانون اعلام تعدیل نیروی کار و آموزش مجدد (WARN)، مسائل مربوط به حقوق تسویه حساب، شرایط واجد شرایط بودن برای دریافت مزایای بیکاری و اینکه چه زمانی اخراج‌های جمعی باید به درستی اعلام شوند را توضیح می‌دهد. حقوق خود را در زمان بازسازی و کاهش نیروهای شرکتی درک کنید.'
    },
    {
      title: 'تبعیض در محیط کار و حقوق مدنی',
      image: '/assets/employment-law/6.webp',
      description: 'آیا در محیط کار خود با برخورد ناعادلانه بر اساس نژاد، جنسیت، سن، معلولیت، مذهب، ملیت یا دیگر ویژگی‌های محافظت‌شده روبه‌رو شده‌اید؟ اطلاعات واضحی در مورد حمایت‌های قانونی تحت عنوان هفتم، تنظیمات معقول تحت قانون حقوق افراد با معلولیت (ADA)، تبعیض در دوران بارداری و نحوه ثبت شکایات تبعیضی دریافت کنید. با حقوق خود تحت قوانین فدرال حقوق مدنی و قوانین ضد تبعیض ایالتی آشنا شوید.'
    }
  ];
  ...
  const whyUseSections = [
    {
      title: 'کمک حقوقی دسترس‌پذیر بدون هیچ‌گونه تعهد',
      image: '/assets/employment-law/7.webp',
      description: 'دسترسی فوری به پشتیبانی حقوقی 24 ساعته در تمام روزهای هفته بدون نیاز به وقت‌گیری، مشاوره‌های طولانی یا هزینه‌های پیش‌پرداخت. چه در حال بررسی نامه‌های اخراج در شب باشید یا با مسائل اضطراری محیط کار در آخر هفته مواجه شوید، "قانون‌کانکت" اطلاعات مورد نیاز شما را دقیقاً زمانی که به آن نیاز دارید، کاملاً رایگان و بدون هیچ‌گونه تعهدی ارائه می‌دهد.'
    },
    {
      title: 'اطلاعات دقیق بر اساس قوانین ایالات متحده',
      image: '/assets/employment-law/8.webp',
      description: 'دستیار هوش مصنوعی "قانون‌کانکت" از مجموعه‌ای جامع از قوانین استخدامی ایالات متحده، مقررات و تصمیمات دادگاه‌ها بهره می‌برد. شما اطلاعات باکیفیت و خاص مربوط به قوانین استخدامی آمریکا دریافت می‌کنید، از جمله تغییرات اخیر در قوانین و اصول حقوقی مستقر، نه اطلاعات کلی که ممکن است به وضعیت شما مرتبط نباشد.'
    },
    {
      title: 'فهم موقعیت خود قبل از اقدام',
      image: '/assets/employment-law/9.webp',
      description: 'مکالمات شما به طور کامل محرمانه و امن باقی می‌ماند. چه در مورد شکایات EEOC، رویه‌های داخلی رسیدگی به شکایات یا مذاکرات توافقی سوال کنید، گزینه‌های خود را به‌طور ایمن و بدون هیچ‌گونه فشاری برای انجام اقدامات رسمی بررسی کنید.'
    }
  ];
