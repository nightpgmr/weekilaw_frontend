...
const ImmigrationLaw = () => {
  ...
  const subcategoriesTitle = 'چه مسائل حقوق مهاجرت می‌تواند دستیار حقوقی هوش مصنوعی ما به شما کمک کند';
  const subcategoriesDescription = 'دستیار حقوقی هوش مصنوعی ما آموزش دیده است تا در طیف وسیعی از مسائل حقوق مهاجرت کمک کند. در اینجا زمینه‌های اصلی که می‌تواند پشتیبانی فوری ارائه دهد آورده شده است:';
  const subCategories = [
    {
      title: 'انواع ویزا و روند درخواست',
      image: '/assets/immigration-law/1.webp',
    ...
    {
      title: 'اقامت دائم',
      image: '/assets/immigration-law/2.webp',
    ...
    },
    {
      ...
      image: '/assets/immigration-law/3.webp',
    ...
    },
    {
      ...
      image: '/assets/immigration-law/4.webp',
    ...
    },
    {
      ...
      image: '/assets/immigration-law/5.webp',
    ...
    },
    {
      ...
      image: '/assets/immigration-law/6.webp',
  ...
  const whyUseTitle = 'چرا از ویکیلا برای کمک در امور مهاجرت استفاده کنید';
  const whyUseDescription = "ویکیلا اولین گام برای درک حقوق قانونی‌تان را آسان می‌کند. در شرایط پیچیده مهاجرتی، با چند پرسش ساده از هوش مصنوعی ما، می‌توانید تصویری روشن از مسیر قانونی خود پیدا کنید. سیستم ما بر پایه‌ی منابع معتبر حقوقی ایران طراحی شده و اطلاعاتی ساده، دقیق و شخصی‌سازی‌شده ارائه می‌دهد.";
  ...
  const howItWorksDescription = "هر پرسشی درباره‌ی ویزا، اقامت یا تابعیت دارید؟ همین حالا از دستیار هوش مصنوعی ویکیلا بپرسید و پاسخ شفاف و رایگان دریافت کنید. ویکیلا – راهنمای هوشمند شما در مسیر مهاجرت.";
  ...
  const faqTitle = 'سؤالات متداول درباره حقوق مهاجرت';
  const faqItems = [
    {
    ...
    },
    {
      ...
      answer: 'می‌توانید درباره ویزا، اقامت، تابعیت، پناهندگی و سایر مسائل مرتبط با حقوق مهاجرت بپرسید.'
    },
    {
  ...
  const helpTitle = 'کمک به یک مسئله مهاجرتی نیاز دارید؟';
  const helpDescription = 'هر پرسشی درباره‌ی ویزا، اقامت یا تابعیت دارید، همین حالا بپرسید و پاسخ رایگان دریافت کنید';
            ...
            <div className="chat_outerWrapper">
              <form onSubmit={handleChatSubmit} className="style-module__chatInputContainer styles-module__outerWrapper">
                <div className="style-module__shinyBorderContainer">
                  <div className="style-module__chatInput styles-module__inputWrapper" id="chat-input-immigration-law">
                    ...
                    <div className="style-module__actions">
                      <button className="style-module__sendButton" type="submit" id="send-button-immigration-law" aria-label="send-button" disabled={!chatInput.trim()}>
                    ...
                    <div className="style-module__inputs style-module__noFiles">
                      <textarea
                        id="double-input-immigration-law"
          ...
          <div className="content_contentContainer">
            <div className="content_sectionContainer">
              <div className="content_innerWidthWrapper">
                ...
                {/* Intro Image */}
                <img
                  alt="ImmigrationLaw intro image"
                  loading="lazy"
                  width="0"
                  height="0"
                  decoding="async"
            ...
            <div className="chat_doubleChatInputWrapper">
              <div className="chat_outerWrapper">
                <form onSubmit={handleLastSectionChatSubmit} className="style-module__chatInputContainer styles-module__outerWrapper">
                  <div className="style-module__shinyBorderContainer">
                    <div className="style-module__chatInput styles-module__inputWrapper" id="chat-input-immigration-law-last-section">
                      <input className="style-module__fileInput" multiple type="file" />
                      <img
                        className="style-module__preTextIcon"
                        src="/assets/spark-gray.svg"
                      ...
                      />
                      <div className="style-module__actions">
                        <button className="style-module__sendButton" type="submit" id="send-button-immigration-law-last-section" aria-label="send-button" disabled={!lastSectionChatInput.trim()}>
                          <div className="style-module__sendArrowImageWrapper">
                            <div className="style-module__sendArrowWrapperHover">
                              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="style-module__sendArrow">
                                <path d="M10.5004 12H5.00043M4.91577 12.2915L2.58085 19.2662C2.39742 19.8142 2.3057 20.0881 2.37152 20.2569C2.42868 20.4034 2.55144 20.5145 2.70292 20.5567C2.87736 20.6054 3.14083 20.4869 3.66776 20.2497L20.3792 12.7296C20.8936 12.4981 21.1507 12.3824 21.2302 12.2216C21.2993 12.082 21.2993 11.9181 21.2302 11.7784C21.1507 11.6177 20.8936 11.5019 20.3792 11.2705L3.66193 3.74776C3.13659 3.51135 2.87392 3.39315 2.69966 3.44164C2.54832 3.48375 2.42556 3.59454 2.36821 3.74078C2.30216 3.90917 2.3929 4.18255 2.57437 4.72931L4.91642 11.7856C4.94759 11.8795 4.96317 11.9264 4.96933 11.9744C4.97479 12.0171 4.97473 12.0602 4.96916 12.1028C4.96289 12.1508 4.94718 12.1977 4.91577 12.2915Z" stroke="#0E5FE3" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"></path>
                      ...
                      <div className="style-module__inputs style-module__noFiles">
                        <textarea
                          id="double-input-immigration-law-last-section"
                          className="style-module__textareaInput style-module__withPreTextIcon"
                          rows="1"
                          placeholder="سؤال حقوقی خود را بپرسید"
                          style={{height: '72px'}}
