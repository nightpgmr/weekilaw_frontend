...
const MainContent = () => {
  ...
  const scrollCarousel = useCallback((direction) => {
    ...
    // In RTL, reverse the scroll directions
    const adjustedDirection = isRTL
      ? (direction === 'left' ? 'right' : 'left')
      : direction;

    const newScrollLeft = adjustedDirection === 'left'
    ...
    setTimeout(() => {
      ...
      setCarouselScrollPosition(percentage);
    }, 300);
  }, []);
            ...
            <div className="stats_statsContainer stats_small">
              <div className="stats_statsWrapper">
                ...
                <div className="stats_statsCard">
                  ...
                  <div className="stats_statsTitle" style={{'--number': '94344', '--transition-duration': '1000ms'}}>۹۴,۳۴۴</div>
                ...
                <div className="stats_statsCard">
                  ...
                  <div className="stats_statsTitle" style={{'--number': '125437', '--transition-duration': '1000ms'}}>۱۲۵,۴۳۷</div>
                ...
                <div className="stats_statsCard">
                  ...
                  <div className="stats_statsTitle" style={{'--number': '677360', '--transition-duration': '1000ms'}}>۶۷۷,۳۶۰</div>
              ...
              <div className="styles-module__container">
                ...
                <div className="styles-module__actionBar knowledge_carouselActionBar">
                  <div className="styles-module__scrollBar">
                    <div className="styles-module__scrolledPosition" style={{width: '16.6667%', left: '0%'}}></div>
                  </div>
                  <div className="styles-module__actionButtonContainer knowledge_carouselArrowButtonContainer">
                    <button className="styles-module__actionButton" disabled={carouselScrollPosition <= 0} onClick={() => scrollCarousel('left')}>
                    ...
                    <button className="styles-module__actionButton" disabled={carouselScrollPosition >= 100} onClick={() => scrollCarousel('right')}>
